...
export const legalItems: {id: string; label: string, href: string;}[] = [
  { id: "mentions-legales", label: "Mentions légales", href: "/legales/mentions-legales" },
  { id: "politique-de-confidentialite", label: "Politique de confidentialité", href: "/legales/politique-de-confidentialite" },
];
